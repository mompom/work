...
<div class="layerpop_wrap add_notice_layer" style="display:none;">
	...
	<div class="layerpop" style="width:500px; top:200px;">
		...
		<div class="layer_content">
			<div class="layer_tit">
				<span class="sub_title">공지사항 등록</span>
				<span class="right" style="float: right;">
					<img alt="" src="/static/img/btn_layer_close.png" height="30px;" width="30px;" style="cursor: pointer;" onclick="javascript:add_notice_layer_close()">
				</span>
			</div>
				...
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tbody>
						<tr class="add_notice_select_box">
							<th>구분</th>
							<td><select name="" id="add_loanId_selectbox" class="select01 add_loanId_selectbox" style="width:153px;"></select></td>
						</tr>
						<tr>
							<th>제목</th>
							<td><input type="text" name="" style="width:100%;" class="insert_title" placeholder="공지 제목을 입력하세요."></td>
						</tr>
						<tr>
							<th>내용</th>
							<td><textarea name="" id="" style="width:93%; height:150px;" class="insert_body" placeholder="공지 내용을 입력하세요."></textarea></td>
						</tr>
					</tbody>
				</table>
				</form>
...
<div class="layerpop_wrap notice_modify_layer" style="display:none;">
	...
	<div class="layerpop" style="width:500px; top:200px;">
		...
		<div class="layer_content">
			<div class="layer_tit">
				<span class="sub_title">공지사항 수정</span>
				<span class="right" style="float: right;">
					<img alt="" src="/static/img/Ok-512.png" height="30px;" width="30px;" style="cursor: pointer;" onclick="javascript:update_notice()">
					<img alt="" src="/static/img/No-512.png" height="30px;" width="30px;" style="cursor: pointer;" onclick="javascript:modify_layer_close()">
				</span>
			</div>
			<!-- wrt_table01 -->
			<div class="wrt_table01">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tbody>
						...
						<tr>
							<th>내용</th>
							<td><textarea class="modify_body" name="" id="" style="width:93%; height:150px; resize: none;">공지 내용을 입력하세요.</textarea></td>
						</tr>
					</tbody>
				</table>
				</form>
...
<!-- 			<div class="layer_btnbox center">
				<button type="button" class="btn_st_normal bt03" onclick="javascript:update_notice()"><span>수정</span></button>
				<button type="button" class="btn_st_normal bt03" onclick="javascript:modify_layer_close()"><span>취소</span></button>
			</div> -->
		</div>
