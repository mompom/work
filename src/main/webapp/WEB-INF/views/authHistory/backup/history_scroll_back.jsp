...
// 			backgroundColor: color('#ff8438').alpha(0.5).rgbString(),
	...
	$(document).on('click', '#excelExport', function(){
		var worksheetName = $('#historyPublicTitleText').text();
		excelExport(this, '#historyPublic', 'historyPublic', 'table', worksheetName);
	});
	...
	$(document).on('click', 'span.company_name, span.company_all', function(){
		...
		$('#company_id').val(company_id);
		$('#historyPublicTitleText').text($(this).text() + ' 계좌인증내역');
	...
	<body>
		<div id="wrap">
			...
			<div id="container">
				...
				<div class="center" id="lst_chart" style="width:85%; overflow: auto; margin: 30px auto 0;">
				...
				<div class="lst_table01" id="lst_table_middle">
					<table class="table center">
						...
						<tfoot>
							<tr>
								<td class=""></td>
								<td class=""><span class="cursor_pointer company_all">전체</span><input id="company_all_input" type="hidden" value=""></td>
				...
				<div class="top_area clearbox">
					<div class="lf_box">
						<strong class="sub_title" id="historyPublicTitleText">전체 계좌인증내역</strong>
						<br>
						<strong class="countTxt"></strong>
						
						<!-- <a class="btn_st_normal" id="excelExport"><span>엑셀 파일 다운로드</span></a> -->
						<a class="btn_st_normal" download="download.xls" href="#" onclick="return ngTableExcelExport.excel(this, 'historyInnerTable', $('#historyPublicTitleText').text());">Export to Excel</a>
					</div>
					<div class="rf_box">
				...
				<div class="contents">
					<!-- lst_table01 -->
					<div id="historyPublicTitle" style="overflow-x: hidden; overflow-y: hidden;">
					<table id="historyTitleTable" class="table center" style="width: 2360px;">
					<colgroup>
	                	<col style="width:60px;">
	                	<col style="width:95px; max_width:95px;" class="hide">
	                ...
	                <thead>
						<tr style="border-bottom:1px solid #dbdbdb;">
							...
							<th class="border_right hide">업체명</th>
					...
					<div class="lst_table01 scroll_overlay" id="historyPublic" style="max-height:700px;">
						<table id="historyInnerTable" class="table center"  style="width: 2360px;">
			                <colgroup>
			                	<col style="width:60px;">
			                	<col style="width:95px; max_width:95px;" class="hide">
			                	<col style="width:285px;">
			                ...
			                <thead style="display: none;">
								<tr>
									...
									<th class="border_right">계좌번호</th>
									<th class="border_right">은행명</th>
									<th class="border_right">실명확인 여부</th>
									<th class="border_right">실명확인 요청일시</th>
									<th class="border_right">입금이체 성공여부</th>
									<th class="border_right">입금이체 요청일시</th>
									<th class="border_right">인증완료 여부</th>
									<th class="border_right">인증완료 일시</th>
									<th class="border_right">사용플랫폼</th>
									<th class="border_right">금결원 결과메시지</th>
									<th class="border_right">개별은행 결과메시지</th>
									<th>은행명</th>
								</tr>
							</thead>
							<tbody>
