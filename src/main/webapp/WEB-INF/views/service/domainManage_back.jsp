				...
				<div class="contents">
					...
					<div class="top_area clearbox" id="lst_table_domainInfo_title">
						<div class="lf_box">
							...
							<br>
							<strong class="sub_txt">도메인 삭제 시 하위 URL주소도 같이 삭제되며, 삭제 시 만전을 기해주시기 바랍니다.</strong>
						</div>
						<div class="rf_box">
						</div> 
						...
						<table class="table center" cellspacing="0" cellpadding="0">
							...
							<tbody>
								<tr>
									...
									<td>
										<input type='text' id="domain_input_text" class="width_max disabled" value="">
									</td>
									<td>
										<button type="button" id="domain_insert_btn" class="btn_st_100 bt01 width_max"><span>+ 등록</span></button>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table center" cellspacing="0" cellpadding="0">
			                ...
			                <thead>
								<tr>
									...
									<th class="border_right">서비스<br>번호</th>
						...
						<table class="table center" cellspacing="0" cellpadding="0">
			                ...
			                <thead>
								<tr>
									...
									<th class="width_217 border_right">서비스 번호</th>
									<th class="width_217">확인</th>
								</tr>
								<tr>
									<td>
										<select id="domainList_select" class="select01 width_max disabled">
										</select>
									</td>
									...
									<td>
										<button type='button' id='domainUri_insert_btn' class='btn_st_100 bt01 width_max'><span>+ 등록</span></button>
									</td>
								</tr>
							</thead>
							<tbody></tbody>
